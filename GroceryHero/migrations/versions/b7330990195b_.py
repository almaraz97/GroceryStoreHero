...
def upgrade():
    ...
    with op.batch_alter_table('pub__rec', schema=None) as batch_op:
        batch_op.add_column(sa.Column('options', sa.JSON(), nullable=False, default={}))
        batch_op.add_column(sa.Column('price', sa.JSON(), nullable=False, default={}))
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        batch_op.add_column(sa.Column('reports', sa.JSON(), nullable=False, default={'Reports': [], 'Reported': []}))
